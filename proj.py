# -*- coding: utf-8 -*-
"""
Created on Thu Apr 25 16:24:59 2019
...
def game_loop():
    ...
    sensor1_x = 0
    sensor1_y = 0
#    sensor1[2] = (sensor1_x, sensor1_y)
#    sensor2_x = 0
#    sensor2_y = 0
#    sensor2[2] = (sensor2_x, sensor2_y)
#    sensor3_x = 0
#    sensor3_y = 0
#    sensor3[2] = (sensor3_x, sensor3_y)
    signal1 = 0
#    signal2 = 0
#    signal3 = 0
    
    bond = np.zeros((800,600))

    #def move(self, rotation):
    pos = pygame.math.Vector2(*velocity) + pos
        #self.rotation = rotation
        #self.angle = self.angle + self.rotation
    sensor1 = pygame.math.Vector2((30, 0)) + pos
        #self.sensor2 = pygame.math.Vector2((30, 0)).rotate((self.angle+45)) + self.pos
        #self.sensor3 = pygame.math.Vector2((30, 0)).rotate((self.angle-45)) + self.pos
        
        #signal1 = int(np.sum(bond[int(sensor1_x)-10:int(sensor1_x)+10, int(sensor1_y)-10:int(sensor1_y)+10]))/400.
        #self.signal2 = int(np.sum(bond[int(self.sensor2_x)-10:int(self.sensor2_x)+10, int(self.sensor2_y)-10:int(self.sensor2_y)+10]))/400.
        #self.signal3 = int(np.sum(bond[int(self.sensor3_x)-10:int(self.sensor3_x)+10, int(self.sensor3_y)-10:int(self.sensor3_y)+10]))/400.
        #print (str(self.signal1)+','+str(self.signal2)+','+str(self.signal3))
        #if sensor1_x>longueur-10 or sensor1_x<10 or sensor1_y>largeur-10 or sensor1_y<10:
         #   signal1 = 1.
#        if sensor2_x>longueur-10 or sensor2_x<10 or sensor2_y>largeur-10 or sensor2_y<10:
#            signal2 = 1.
#        if sensor3_x>longueur-10 or sensor3_x<10 or sensor3_y>largeur-10 or sensor3_y<10:
#            signal3 = 1.
